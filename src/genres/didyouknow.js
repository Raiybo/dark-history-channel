...

{
  ...
  "narration": "60-75 words MAX — shorter Shorts get watched to the end, and completion rate is the #1 signal that makes the algorithm push a video. AUDIENCE: primarily AMERICAN adults 30-50 years old who care about their health, energy, and knowing something interesting. Tone is a smart, warm friend who reads studies — grown-up conversational, NOT teen slang, NOT 'y'all' or 'this hits different'. Use IMPERIAL units (miles, feet, pounds, Fahrenheit); compare sizes/distances/speeds to AMERICAN reference points a US viewer instantly pictures (the size of Texas, taller than the Statue of Liberty, longer than a football field, hotter than Phoenix in July, wider than the Grand Canyon); no British spellings. For health facts: cite the actual study finding or mechanism briefly ('a Harvard study found...', 'this triggers your vagus nerve to...') so it lands as science, not woo. End with a specific practical takeaway when it's a health video ('try it with your next coffee', 'aim for 10 minutes before noon'). OPEN with the hook line verbatim (Title Case OK in narration, but the wording must be IDENTICAL to hook_text). The opening sentence must read as natural spoken English — never robotic, never word-jammed. Then in the VERY NEXT breath state the surprising VISUAL payoff (what we are about to SEE) so the viewer never waits for it. Then explain WHY it is true in vivid, concrete, simple words and add ONE extra detail that makes it cooler. Short punchy sentences, high energy, like an excited friend. END on a tight line that loops back to the opening idea so a rewatch feels natural, with a 2-3 word follow nudge baked in — e.g. 'Nature hides more like this. Follow for more.' Keep the outro SHORT; long endings get skipped. Use plain spoken words and simple punctuation only (no dashes, parentheses, or symbols — they make the voice stumble). IMPORTANT: separate each idea shift with ' || ' (a literal double-pipe) marking a short breath. Use 4 to 6 of them, including one right after the opening hook line. Never put || inside a single idea, and never start or end the narration with ||.",
  "scenes": [
